...
describe('StormGlass client', () => {
  ...
  it ('should get a generic error from StormClass service then the request fail before reaching the service', async() => {
    const lat = -33.792726;
    const lng = 151.289824;

    mockedRequest.get.mockResolvedValue({message: 'Network Error'});
